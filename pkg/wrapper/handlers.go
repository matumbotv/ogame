...
// 	bot := c.Get("bot").(*OGame)
// 	report, err := bot.GetExpeditionMessages()
// 	if err != nil {
// 		return c.JSON(http.StatusInternalServerError, ErrorResp(500, err.Error()))
// 	}
// 	return c.JSON(http.StatusOK, SuccessResp(report))
...
func GetExpeditionMessagesHandler(c echo.Context) error {
	bot := c.Get("bot").(*OGame)
	report, err := bot.GetExpeditionMessages(-1)
	if err != nil {
		return c.JSON(http.StatusInternalServerError, ErrorResp(500, err.Error()))
	}
	return c.JSON(http.StatusOK, SuccessResp(report))
...
func GetExpeditionMessagesHandler2(c echo.Context) error {
	bot := c.Get("bot").(*OGame)
	_, err := bot.GetExpeditionMessages(-1)
	if err != nil {
		return c.HTML(http.StatusOK, err.Error())
	}
	html := `<br /><hr><br /><CENTER>TEST<CENTER/><br /><hr><br /><br />`
	return c.HTML(http.StatusOK, html)
}

// GetExpeditionReportHandler ...
// func GetExpeditionReportHandler(c echo.Context) error {
// 	bot := c.Get("bot").(*OGame)
// 	msgID, err := utils.ParseI64(c.Param("msgid"))
// 	if err != nil {
// 		return c.JSON(http.StatusBadRequest, ErrorResp(400, "invalid msgid id"))
// 	}
// 	expeditionReport, err := bot.GetExpeditionReport(msgID)
// 	if err != nil {
// 		return c.JSON(http.StatusInternalServerError, ErrorResp(500, err.Error()))
// 	}
// 	return c.JSON(http.StatusOK, SuccessResp(expeditionReport))
// }
